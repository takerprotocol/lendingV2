...
import MobileDeaderHeaderSkeleton from '../mobileDepositSkeleton/MobileDeaderHeaderSkeleton'
...
export default function MobileHeader({ loading }: MobileHeaderProps) {
