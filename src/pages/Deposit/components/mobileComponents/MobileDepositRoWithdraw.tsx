...
import MobileDepositRoWithdrawSkeleton from '../mobileDepositSkeleton/MobileDepositRoWithdrawSkeleton'
import MobileDeaderListSkeleton from '../mobileDepositSkeleton/MobileDeaderListSkeleton'
...
export default function MobileDepositRoWithdraw({
  ...
  return (
    <>
      {loading ? (
        <MobileDepositRoWithdrawSkeleton />
      ) : (
        <MainBox>
          <DepositBox
      ...
      <>
        {loading ? (
          <MobileDeaderListSkeleton></MobileDeaderListSkeleton>
        ) : (
          <>
            {type === 1 ? (
              <MobileDeposit
