...
import OverviewSkeleton from './DashboardSkeleton/OverviewSkeleton'
...
export default function Overview({ loading, type }: OverviewType) {
  ...
  return (
    <Box>
                ...
                <OverviewFlexBox marginTop="1.5rem">
                  <NetAPY width="247px">
                    <OverviewFlexBox sx={{ justifyContent: 'flex-start' }}>
                      <Typography variant="subtitle2" marginRight=".375rem">
                        Net APY
                      </Typography>
                      <img width="14px" height="14px" src={greyPrompt} alt="" />
                    </OverviewFlexBox>
                    <Box marginTop=".25rem">
                      <Typography variant="h4" fontWeight="600" marginBottom="1.375rem">
                        15%
                      </Typography>
                    </Box>
                  ...
                  <NetAPY marginLeft="1.5rem">
                    ...
                    <Typography component="span" variant="h4" fontWeight="600" marginLeft=".4375rem">
                      26.74
                    </Typography>
                    <Box sx={{ opacity: '0.5', border: ' 0.5px solid #D9DBE9', marginTop: '22px' }}></Box>
                    <OverviewFlexBox sx={{ justifyContent: 'flex-start', marginTop: '1.4375rem' }}>
                      <Box>
                        <Box sx={{ display: 'flex', alignItems: 'center' }}>
                          ...
                          <Typography marginLeft=".375rem" variant="h5" fontWeight="600" color="#6E7191">
                            10.00
                          </Typography>
                        </Box>
                        <Typography component="p" variant="body1" fontWeight="600" color="#A0A3BD">
                ...
                <Box ml="6.125rem" mt="1.4375rem" width="470px">
                  <Box sx={{ width: '466' }}>
                    <RiskLevel>
                      ...
                      <FlexBox mt=".25rem">
                        <Typography fontSize="1.5rem" lineHeight="2.375rem" fontWeight="700" color="#4BC8B1">
                          HEALTHY
                        </Typography>
      ...
      <OverviewModal open={open} repayRoBorrow={repayRoBorrow} onClose={() => setOpen(false)}></OverviewModal>
    </Box>
  )
}
