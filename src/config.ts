...
const PUNKS_ADDRESS = '0xbb1594cc5c456541b02a24a9132b070b385b7035'
const CHAIN_IDs = [5]
export { gasLimit, LTV_MASK, DECIMALS_MASK, FACTOR_MASK, COLLATERAL_MASK, CHAIN_IDs, PUNKS_ADDRESS }
